...
function App() {
    ...
    const todoListArray: Array<TodoListDomainType> = [
        {id: todoListId1, title: 'What I learn', order: 0, addedDate: '', filter: 'All', entityStatus: 'idle'},
        {id: todoListId2, title: 'What You learn', order: 0, addedDate: '', filter: 'All', entityStatus: 'idle'},
    ]
